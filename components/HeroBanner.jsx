      ...
      <Carousel
        ...
        renderArrowPrev={(clickHandler, hasPrev) => (
          <div
            ...
            className="absolute right-[31px] md:right-[51px] bottom-0 w-[30px] md:w-[50px] h-[30px] md:h-[50px] bg-blue-500 z-10 flex items-center
        ...
        renderArrowNext={(clickHandler, hasNext) => (
          <div
            ...
            className="absolute right-0 bottom-0 w-[30px] md:w-[50px] h-[30px]
                md:h-[50px] bg-blue-500 z-10 flex items-center justify-center cursor-pointer hover:opacity-90"
          >
